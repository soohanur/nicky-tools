...
TS=$(date +%Y%m%d-%H%M%S)
cd /var/www/datainfo
cp backend/app/api/files.py                  backend/app/api/files.py.bak.$TS
cp scraply/src/modules/kadaster_map.py       scraply/src/modules/kadaster_map.py.bak.$TS
cp scraply/src/modules/browser_automation.py scraply/src/modules/browser_automation.py.bak.$TS
...
chown datainfo:www-data backend/app/api/files.py scraply/src/modules/kadaster_map.py scraply/src/modules/browser_automation.py
rm -f /tmp/files.py.new /tmp/kadaster_map.py.new /tmp/browser_automation.py.new
rm -rf scraply/src/modules/__pycache__ backend/app/api/__pycache__
